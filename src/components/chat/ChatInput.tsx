      ...
      <form onSubmit={handleSubmit} className="space-y-3.5">
        ...
        <div className="flex items-end gap-2 sm:gap-3">
          ...
          <button
            ...
            className="btn-shimmer flex min-h-[52px] items-center justify-center gap-2 rounded-lg bg-[var(--color-primary)] px-6 py-3 text-base font-bold text-white shadow-soft transition-all hover:bg-teal-800 hover:shadow-glow disabled:cursor-not-allowed disabled:opacity-50"
          >
