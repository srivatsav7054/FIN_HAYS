  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="surface-card border-teal-200 bg-gradient-to-r from-teal-50 via-teal-50/70 to-teal-100/40 p-6"
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-teal-100 text-teal-800 shadow-2xs">
            ...
            <div>
              ...
              <div className="font-mono text-2xl font-extrabold text-teal-950">
                ₹{surplus.toLocaleString("en-IN")} / {t.perMonth}
              </div>
            </div>
          </div>

          <div className="text-xs font-semibold text-teal-900 bg-white/75 rounded-lg px-3.5 py-2 border border-teal-200">
