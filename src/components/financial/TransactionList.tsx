    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[var(--color-border)] pb-4">
        ...
        <button
          ...
          className="btn-shimmer flex min-h-[46px] items-center justify-center gap-2 rounded-2xl bg-[var(--color-primary)] px-5 text-sm font-bold text-white shadow-soft transition-all hover:bg-teal-800 hover:shadow-glow"
        >
