  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute -bottom-8 h-10 w-48 rounded-[100%] bg-emerald-950/20 blur-md pointer-events-none transition-all duration-700"
          style={{
        ...
        <div
          className="absolute inset-9 rounded-full border border-emerald-400/35 pointer-events-none"
          style={{
        ...
        <motion.div
          ...
          className="absolute inset-0 pointer-events-none"
        >
          <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex h-6 w-6 items-center justify-center rounded-full bg-emerald-500 text-[11px] font-black text-white shadow-md">
            🌾
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative flex h-34 w-34 cursor-pointer items-center justify-center rounded-full border-2 border-emerald-300/80 bg-gradient-to-b from-white via-white/90 to-emerald-50/80 backdrop-blur-lg shadow-2xl transition-all duration-200"
          style={{
            boxShadow: isHovered
        ...
        <motion.button
          ...
          className={`absolute -top-2 left-2 z-30 flex items-center gap-1.5 rounded-full border px-3.5 py-1.5 text-xs font-extrabold shadow-lift backdrop-blur-md transition-all ${
            activeNode === "income"
              ? "border-[var(--color-primary)] bg-[var(--color-primary)] text-white ring-4 ring-emerald-100"
        ...
        <div className="absolute top-8 left-10 h-2.5 w-2.5 rounded-full bg-emerald-400 opacity-80 animate-ping pointer-events-none" />
