  ...
  return (
    <div className="app-shell relative flex min-h-screen flex-col overflow-x-hidden">
      ...
      <main className="flex-1 relative z-10 flex flex-col justify-center">
        {/* Hero Section */}
        <section className="relative px-4 sm:px-6 lg:px-8 pt-8 pb-16 sm:pt-16 sm:pb-24 overflow-hidden">
          <img src="/images/saahara/rural-women-phone-01.png" alt="" className="pointer-events-none absolute inset-0 h-full w-full object-cover opacity-25 -z-10" />
              ...
              >
                ...
                <motion.div variants={heroItem} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
                  ...
                  >
                    <Link
                      to="/login"
                      className="btn-shimmer flex min-h-[56px] items-center justify-center gap-3 rounded-lg bg-[var(--color-primary)] px-8 py-3.5 text-base font-bold text-white shadow-lift transition-all hover:shadow-glow hover:bg-teal-800"
                    >
                ...
                <motion.div variants={heroItem} className="pt-4 flex flex-wrap items-center gap-6 text-xs sm:text-sm font-semibold text-[var(--color-muted-foreground)]">
                  ...
                  <motion.div
                    ...
                    className="flex items-center gap-2"
                  >
                    <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-teal-100 text-[var(--color-primary)] shadow-2xs">
